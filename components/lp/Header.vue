    ...
    <section id="header">
        ...
        <div class="container-text">
            <div class="text-wrapper bg-white position-relative">
                <h1>Sambutlah kebahagiaan dan berkah aqiqah dengan layanan terbaik kami.</h1>
                <p>Ayo perkuat ikatan keluarga dalam momen istimewa ini dengan pilihan menu halal dan paket lengkap dari <strong>Aqiqah Emak</strong></p>
            </div>
        </div>
    </section>
</template>
